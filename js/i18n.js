...
const translations = {
  fr: {
    ...
    "nav.gallery": "Photos",
    "nav.contact": "Contact",
    "hero.tagline": "Cuisine méditerranéenne tunisienne, fraîche de la mer et préparée avec passion comme à la maison, depuis 1994.",
    "hero.cta_menu": "Voir le menu",
    "hero.cta_call": "Appeler",
    "about.text": "Depuis le cœur de Sousse, Mare Mar sert une cuisine de la mer simple et généreuse — produits frais, recettes tunisiennes, dans une ambiance familiale chaleureuse.",
    "about.feat_fresh": "Produits frais",
    "about.feat_tunisian": "Recettes tunisiennes",
    "about.feat_heritage": "Depuis 1994",
    "about.feat_terrace": "Terrasse",
    "about.feat_family": "Ambiance familiale",
  ...
  ar: {
    ...
    "nav.gallery": "الصور",
    "nav.contact": "تواصل",
    "hero.tagline": "مكلة متوسطية وتونسية، فرشكة من البحر ومحضرة بالحب كيف في الدار، من 1994.",
    "hero.cta_menu": "شاهد القائمة",
    "hero.cta_call": "اتصل بنا",
    "about.text": "من قلب سوسة، يقدم مار مار مأكولات بحرية بسيطة وسخية — منتجات طازجة، أطباق تونسية أصيلة، في أجواء عائلية دافئة.",
    "about.feat_fresh": "منتجات طازجة",
    "about.feat_tunisian": "وصفات تونسية",
    "about.feat_heritage": "منذ 1994",
    "about.feat_terrace": "تراس",
    "about.feat_family": "أجواء عائلية",
    "menu.title": "قائمتنا",
    ...
    "contact.hours_main": "الثلاثاء – الأحد : 11:30 – 22:30",
    "contact.hours_note": "الإثنين : 17:00 – 22:30",
  ...
  en: {
    ...
    "nav.gallery": "Photos",
    "nav.contact": "Contact",
    "hero.tagline": "Mediterranean Tunisian cuisine, fresh from the sea, made with passion like home, since 1994.",
    "hero.cta_menu": "View menu",
    "hero.cta_call": "Call us",
    "about.text": "From the heart of Sousse, Mare Mar serves simple, generous seafood — fresh ingredients, Tunisian recipes, in a warm family atmosphere.",
    "about.feat_fresh": "Fresh produce",
    "about.feat_tunisian": "Tunisian recipes",
    "about.feat_heritage": "Since 1994",
    "about.feat_terrace": "Terrace",
    "about.feat_family": "Family atmosphere",
    "menu.title": "Our Menu",
